                ...
                <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <select name="game" id="game"
                            className='bg-zinc-900 px-3 py-4 rounded text-sm placeholder:zinc-500 appearance-none'
                            defaultValue="">
                    ...
                    <div className='flex  gap-6'>
                        <div className='flex flex-col gap-2'>
                            ...
                            <ToggleGroup.Root type="multiple" className='grid grid-cols-4 gap-1'
                                value={weekDays} onValueChange={setWeekDays}>
                    ...
                    <label className='mt-2 flex  items-center gap-2 text-sm'>
                        <Checkbox.Root className="w-6 h-6 p-1 rounded bg-zinc-900" checked={useVoiceChannel}
